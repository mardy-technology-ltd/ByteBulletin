...
export function LiveTicker({
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between h-11 text-xs sm:text-sm font-medium">
        ...
        <div className="flex items-center shrink-0 mr-4">
          ...
          <span className="uppercase tracking-widest font-extrabold text-[11px] text-violet-600 dark:text-violet-400">
            Breaking News
          </span>
        </div>
        ...
        <div className="flex-1 truncate border-l border-violet-500/20 pl-4">
          <Link
            ...
            className="hover:underline inline-flex items-center group animate-in fade-in slide-in-from-bottom-2 duration-300 w-full"
          >
            <span className="truncate mr-2 font-semibold text-foreground/90 group-hover:text-primary transition-colors">
              {currentItem.title}
            </span>
        ...
        {totalItems > 1 && (
          <div className="flex items-center space-x-2 shrink-0 ml-4 border-l border-violet-500/20 pl-3 text-xs font-semibold text-muted-foreground">
            <span className="text-[11px] font-extrabold text-violet-500/80 mr-1 hidden sm:inline">
