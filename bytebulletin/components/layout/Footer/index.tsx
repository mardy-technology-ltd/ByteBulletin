...
export function Footer() {
  return (
    <footer className="border-t py-12 md:py-16 bg-slate-100/90 dark:bg-slate-950/90 text-foreground border-border/50 transition-colors">
      <div className="max-w-[1536px] mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="col-span-1 md:col-span-1 space-y-4">
          <Link href="/" className="font-bold text-2xl inline-block font-heading text-slate-900 dark:text-white group">
          ...
          <p className="text-xs text-muted-foreground pt-2">
            ...
            <a href="https://thebytebulletin.com" className="hover:underline text-primary font-medium">
              thebytebulletin.com
            </a>
            . All rights reserved.
          </p>
        ...
        <div className="col-span-1 space-y-3">
          ...
          <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
            ...
            <li>
              <Link href="/disclosures" className="hover:text-primary transition-colors">
